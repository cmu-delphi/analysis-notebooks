...
| `guiding_indicator`      | Indicator name for the guiding indicator           | `confirmed_admissions_covid_1d`   |
...
| `candidate_indicator`    | Indicator name for the candidate indicator         | `anosmia_raw_search`              |
